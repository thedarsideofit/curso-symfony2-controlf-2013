...
use ControlF\CatalogoBundle\Entity\Producto;
use ControlF\CatalogoBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ControlFCatalogoBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("ControlFCatalogoBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ControlFCatalogoBundle:Producto')->find($id);
     ...
     * @Method("PUT")
     * @Template("ControlFCatalogoBundle:Producto:edit.html.twig")
     */
