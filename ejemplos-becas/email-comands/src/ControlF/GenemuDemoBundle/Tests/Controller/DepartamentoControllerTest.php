...
namespace ControlF\GenemuDemoBundle\Tests\Controller;
...
class DepartamentoControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'controlf_genemudemobundle_departamentotype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'controlf_genemudemobundle_departamentotype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
